...
class AntelopeTable extends AbstractTable
{
    ...
    protected function configure(TableConfiguration $config): TableConfiguration
    {
        ...
        // TODO-1: Set the table header antelope-id, name and color by passing an associative array of columns
        // Hint-1: Array keys are the constants
        // Hint-2: The values are the column names of the table visible in the browser

        // TODO-2: Make the columns antelope-id, name and color sortable
        // Hint-1: Pass the keys of the columns that should be sortable

        // TODO-3: Make the columns name and color searchable
